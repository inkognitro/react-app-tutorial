...
You start to implement it, and then you realize: the current solutions only supports string placeholders :fearful:
...
Whatever the boss wanted, until now we were able to todo it :angel:
